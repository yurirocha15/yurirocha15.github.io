...
\begin{cvcolumns}
  ...
  \cvrole{Doosan Robotics}{ago. 2025--presente}{Engenheiro sênior de software --- AI \& Software}{}
  \begin{cvbullets}
    \item Projeto e desenvolvo software central de controle em tempo real, incluindo gerenciamento de tarefas e fluxo de dados.
    \item Desenvolvo interfaces para agentes operarem robôs reais e uma plataforma Kubernetes para implantar LLMs e simulações com monitoramento de métricas.
  ...
  \begin{cvbullets}
    ...
    \item Otimizei LLMs e grafos ONNX nos níveis de modelo e grafo para implantação e avaliação em NPUs de dispositivos de borda.
  \end{cvbullets}
