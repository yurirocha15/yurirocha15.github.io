...
\begin{cvcolumns}
  ...
  \begin{cvbullets}
    ...
    \item Em uma atuação de um ano em ML, otimizei LLMs e grafos ONNX nos níveis de modelo e grafo para implantação e avaliação em NPUs de dispositivos de borda.
  \end{cvbullets}
