...
\cvmainsection{기술}
\cvproject{소프트웨어}{C++, Python, Go, Linux, JavaScript, Node.js, Software Architecture}
...
\begin{cvbullets}
  \item 수백 대의 로봇이 배치된 자동차 용접 조립 라인을 위한 로봇 프로그램 자동 생성 시스템의 소프트웨어 아키텍처를 주도했습니다.
  \item 산업용 로봇 프로그래밍 소요 시간을 약 6주에서 3일로 단축했습니다.
  \item ROS, MoveIt, OMPL 및 MongoDB 기반의 고병렬 C++ 플래닝 알고리즘을 개발하여 작업점 검증, 궤적 생성 및 평가, 작업 분배, 로봇 간 충돌 회피 협업을 구현했습니다.
  ...
  \item 1년간의 ML 업무에서 모바일 엣지 디바이스 배포를 위해 LLM 아키텍처를 모델 수준에서 최적화했습니다.
...
\begin{cvbullets}
  \item 공공 조달 플랫폼과 고객 ERP 시스템 간 연동을 자동화하는 Node.js 서비스를 개발했습니다. 이 연동은 플랫폼 운영 시간을 줄이고 회사의 주요 판매 요소가 되었으며, 웹사이트 백엔드 개발과 고객 기술팀 협업도 수행했습니다.
\end{cvbullets}

\cvmainsection{학력 \& 연구}
\cvrecord{전자전기컴퓨터공학 석사}{2018--2020}{성균관대학교, GPA 4.4/4.5. 시맨틱 지식 프레임워크 연구에 참여하고 ROS와 Gazebo 기반 자동 멘탈 시뮬레이션 시스템을 개발했으며, 강화학습 자율주행 및 하이브리드 플래닝을 연구했습니다.}
\cvrecord{제어 및 자동화공학 학사}{2011--2016}{University of Brasilia, GPA 4.1/5.0. Dual quaternion 기반 협동 조작 방법을 도출하고 NAO와 V-REP에서 제어 전략을 구현했으며 OpenCV 기반 로봇 간 시각 통신을 개발했습니다.}
...
\cvrecord{정부초청장학생 학업성취상}{2019}{Korean Government Scholarship Program}
...
\cvmainsection{등록 특허}
\cvrecord{로봇 공정 프로그램 생성}{\href{https://patents.google.com/patent/KR102590491B1}{KR102590491B1}}{}
\cvrecord{로봇 공정의 유효 작업점 결정}{\href{https://patents.google.com/patent/KR102626109B1}{KR102626109B1}}{}
\cvrecord{산업용 로봇 작업 경로 생성}{\href{https://patents.google.com/patent/KR102629021B1}{KR102629021B1}}{}
\cvrecord{로봇 작업 경로 길이 계산}{\href{https://patents.google.com/patent/KR102660168B1}{KR102660168B1}, \href{https://patents.google.com/patent/KR102638245B1}{KR102638245B1}}{}
\cvrecord{다수 로봇 간 작업점 분배}{\href{https://patents.google.com/patent/KR102614099B1}{KR102614099B1}, \href{https://patents.google.com/patent/US12093832B2}{US12093832B2}}{}
\cvrecord{작업 로봇 간 충돌 방지}{\href{https://patents.google.com/patent/US12049013B1}{US12049013B1}}{}
\end{document}
