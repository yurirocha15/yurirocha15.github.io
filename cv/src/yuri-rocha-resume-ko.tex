...
\begin{cvcolumns}
  ...
  \begin{cvbullets}
    \item 고성능 로봇 컨트롤러의 핵심 C++ 소프트웨어를 설계하고 개발하고 있습니다.
    \item 지속적인 개발과 배포를 지원하기 위해 내부 Kubernetes 클러스터를 운영하고 CI/CD 및 LLMOps 파이프라인을 유지보수하고 있습니다.
    \item 로봇 애플리케이션 개발자가 사용하는 공식 C++ API와 ROS 패키지의 개발, 릴리스 및 유지보수 전반을 주도하고 있습니다.
  \end{cvbullets}
