...
export const koreanPortfolioContent = {
  ...
  profile: {
    ...
    hero: {
      ...
      heading: "피지컬 AI를 위한\n신뢰성 높은\n소프트웨어를 만듭니다.",
      lead:
        "실시간 로봇 컨트롤러 소프트웨어와 에이전틱 워크플로를 협동 로봇에 연결하는 인터페이스를 설계합니다. 산업용 모션 플래닝, 모델 및 그래프 수준의 AI 최적화, Kubernetes 기반 LLMOps 및 시뮬레이션 인프라 분야에서도 일해 왔습니다.",
    },
    engineeringProfile: {
      label: "엔지니어링 프로필",
  ...
  experience: [
    ...
    },
    {
      ...
      company: "마키나락스",
      detail:
        "대규모 점용접 라인의 로봇 프로그램 자동 생성, 병렬 C++ 플래닝, 확장 가능한 배포 인프라, 모델 및 그래프 수준의 LLM 최적화를 수행했습니다.",
      bullets: [
