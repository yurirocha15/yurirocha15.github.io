...
export const koreanPortfolioContent = {
  locale: "ko",
  metadata: {
    title: "유리 허샤 - 로보틱스 소프트웨어 & Physical AI",
    description:
      "실시간 로봇 컨트롤러, 에이전틱 로보틱스 인터페이스, 모션 플래닝 시스템, Kubernetes LLMOps 인프라를 개발하는 시니어 로보틱스 소프트웨어 엔지니어 유리 허샤의 포트폴리오입니다.",
  },
  profile: {
    skipLinkLabel: "본문으로 건너뛰기",
    identity: {
      name: "유리 허샤",
      title: "로보틱스 소프트웨어 · Physical AI",
      mark: "YR",
      homeLabel: "유리 허샤 홈",
    },
    navigation: [
    ...
    hero: {
      ...
      heading: "Physical AI를 위한 신뢰성 높은 소프트웨어를 만듭니다.",
      lead:
    ...
    engineeringProfile: {
      label: "엔지니어링 프로필",
      title: "로보틱스 및 Physical AI를 위한 소프트웨어 아키텍처",
      groups: [
        {
        ...
        },
        {
          ...
          items: ["Isaac Sim", "MuJoCo", "Unity3D", "Gazebo", "강화학습"],
        },
      ],
    },
    contact: {
  ...
  experience: [
    {
      ...
      company: "두산로보틱스",
      detail:
        "실시간 로봇 컨트롤러 아키텍처, 에이전틱 통합, Kubernetes LLMOps 및 공식 개발자 API를 담당합니다.",
      bullets: [
        ...
        "개발자가 Kubernetes에 LLM과 시뮬레이션 환경을 배포하고 관련 메트릭을 모니터링할 수 있는 웹 플랫폼을 설계하고 개발했습니다.",
        "공식 오픈 소스 C++ API와 ROS 패키지의 개발, 릴리스 주기 및 지속적인 유지보수를 주도하고 있습니다.",
      ],
    ...
    },
    {
      ...
      company: "마키나락스",
      detail:
        "대규모 점용접 라인의 로봇 프로그램 자동 생성, 병렬 C++ 플래닝, 확장형 배포 및 모델 수준 LLM 최적화를 수행했습니다.",
      bullets: [
        "수백 대의 로봇이 배치된 점용접 조립 라인을 위한 로봇 프로그램 자동 생성 시스템의 소프트웨어 아키텍처를 주도하여 작업 시간을 약 6주에서 3일로 단축했습니다.",
        "ROS, MoveIt, OMPL 및 MongoDB 기반의 고병렬 C++ 플래닝 알고리즘을 개발하여 작업점 검증, 궤적 생성 및 평가, 작업 분배, 충돌 회피 협업을 구현했습니다.",
        "연산 집약적인 플래닝 워크로드를 위한 Kubernetes/Docker 인프라를 구축·운영하고 빌드, 테스트, 패키징 및 배포를 위한 Linux/GitHub Actions CI/CD를 유지보수했습니다.",
        "PyTorch와 Unity3D를 사용해 모방학습 및 강화학습 실험과 시뮬레이션 개발을 수행했습니다.",
        "1년간의 ML 업무에서 모바일 엣지 디바이스를 대상으로 모델 및 그래프 최적화, 양자화, 반복 가능한 평가를 위한 PyTorch/ONNX 워크플로를 구축했습니다.",
      ],
  ...
  professionalProjects: [
    ...
    },
    {
      ...
      title: "LLM 및 시뮬레이션용 Kubernetes 플랫폼",
      description:
        "개발자가 내부 Kubernetes 클러스터에 LLM과 시뮬레이션 환경을 배포하고 워크로드 메트릭을 모니터링할 수 있는 웹 플랫폼입니다.",
      visual: "gpu-platform",
      layout: "standard",
      bullets: [
        "LLM 및 로보틱스 시뮬레이션 환경을 셀프서비스 방식으로 배포합니다.",
        "동일한 운영 인터페이스에서 워크로드 메트릭을 확인할 수 있습니다.",
        "내부 클러스터 운영과 CI/CD 및 LLMOps 파이프라인을 기반으로 지원됩니다.",
      ],
    ...
    },
    {
      ...
      description:
        "수백 대의 로봇이 배치된 점용접 라인의 자동 로봇 프로그래밍 시스템 아키텍처를 주도하여 작업 시간을 6주에서 3일로 단축했습니다.",
      visual: "smart-frame",
      layout: "wide-visual",
      bullets: [
        "작업점 검증, 궤적 생성 및 평가, 작업 분배, 충돌 회피 협업을 위한 병렬 C++ 플래닝을 개발했습니다.",
        "ROS, MoveIt, OMPL, MongoDB 알고리즘을 확장 가능한 Kubernetes 및 Docker 플래닝 인프라와 결합했습니다.",
      ],
    ...
    },
    {
      ...
      description:
        "카메라 이미지로 상자를 검사하고 손상된 제품을 제외하며, 추론한 내용물의 무게와 취약성에 따라 그립 강도, 이동 속도 및 배치를 조정하는 엔드투엔드 팔레타이징 시스템입니다.",
      visual: "palletizer",
      layout: "standard",
      bullets: [
        "합성 데이터로 Cosmos Reason2를 LoRA 파인튜닝하고 네 개의 컨테이너 서비스로 판단 결과를 Isaac Sim 및 cuRobo에 연결했습니다.",
    ...
    },
    {
      ...
      title: "모바일 추론을 위한 모델 수준 LLM 최적화",
      description:
        "모바일 엣지 환경을 대상으로 모델 및 그래프 수준에서 LLM 아키텍처와 ONNX 그래프를 최적화했습니다.",
      visual: "edge-llm",
      layout: "standard",
      bullets: [
  ...
  openSourceProjects: [
    ...
    },
    {
      ...
      title: "topic",
      description:
        "컨테이너화된 소프트웨어가 실제로 경험하는 방식으로 리소스 사용량을 보여 주는 터미널 모니터입니다.",
      visual: "topic",
      layout: "standard",
      bullets: [
        "호스트 전체가 아닌 cgroup 제한을 기준으로 CPU와 메모리를 표시합니다.",
        "Docker, Kubernetes, NVIDIA/NVML, 터미널 제어 및 JSON 스냅샷을 지원합니다.",
      ],
    ...
    },
    {
      ...
      title: "leet2git",
      description:
        "인증된 LeetCode 브라우저 세션으로 문제와 통과한 제출물을 수집해 구조화된 Git 리포지토리로 가져오는 웹 스크레이퍼 및 CLI입니다.",
      visual: "leetcode",
      layout: "standard",
  ...
  contributions: [
    {
      ...
      description:
        "AIT* 및 EIT*의 샘플링, 그래프 유효성, 종료 조건, 설정 전 초기화 오류를 수정하고 중간 해 콜백을 추가했습니다.",
    ...
    },
    {
      ...
      description:
        "Quill 번들 fmt와 Boost.SML 연산자 오버로드를 함께 사용할 때 발생하는 구형 GCC 컴파일 오류를 수정했습니다.",
    ...
    },
    {
      ...
      description:
        "ROS 카메라가 도메인 무작위화된 색상을 관찰할 수 있도록 Gazebo Transport를 통해 런타임 시각 업데이트를 게시했습니다.",
    ...
    },
    {
      ...
      description: "하위 프로젝트에서 사용할 수 있도록 C++ 헤더의 CMake 설치 문제를 수정했습니다.",
